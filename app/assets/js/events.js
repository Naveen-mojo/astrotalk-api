...
window.addEventListener('load', () => {
    ...
    document.getElementById('create-room').addEventListener('click', (e) => {
        ...
        let roomName = document.querySelector('#room-name').value = 'room';
        ...
        if (roomName && yourName) {
            ...
            //create room link
            let roomLink = `${location.origin}/video-call?room=${roomName.trim().replace(' ', '_')}_${helpers.generateRandomString()}`;
